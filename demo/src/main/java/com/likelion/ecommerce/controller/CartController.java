...
public class CartController {
    ...
    public ResponseEntity<ResponseStandard> getCategoryList(@RequestParam Integer accountId) 
    {
	...
	@PostMapping("/create")
    public ResponseEntity<ResponseStandard> saveCategory(@RequestBody Cart cart)
    {
		ResponseStandard rp = new ResponseStandard();
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponseStandard> updateCategory(@RequestBody Cart cart)
    {
    	ResponseStandard rp = new ResponseStandard();
